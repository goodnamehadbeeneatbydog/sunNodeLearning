...
async function test(fhrate){
    ...
    for(i=0;i<stocks.length;i++){
        ...
        if(body){
            ...
            const stock ={code,name,nrq,'djrq':formatDate(djrq),fhrq,payrq,fhfa,cpr,fhbl}
            ...
            code,name,
            moment(djrq).format('YYYY-MM-DD'),
            moment(fhrq).format('YYYY-MM-DD'),moment(payrq).format('YYYY-MM-DD'),
            fhfa,cpr,fhbl)
        }
